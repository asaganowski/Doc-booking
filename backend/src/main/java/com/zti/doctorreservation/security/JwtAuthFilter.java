 ...
 * Odczytuje nagłówek {@code Authorization: Bearer <token>}, weryfikuje token
 * i ustawia uwierzytelnienie w kontekście Spring Security.
 */
@Component
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    /**
     * Przetwarza każde żądanie HTTP w poszukiwaniu tokenu JWT.
     * Jeśli token jest prawidłowy, ustawia uwierzytelnienie w {@link SecurityContextHolder}.
     *
